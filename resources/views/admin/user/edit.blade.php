    ...
    <div class="max-w-3xl mx-auto bg-white shadow-xl rounded-2xl p-8 mt-8">
        ...
        <form action="{{ route('admin.user.update', $user->user_id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" name="nama_jualan" value="{{ old('nama_jualan', $user->rombong->nama_jualan ?? '') }}"
                    class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-yellow-500" required>
            </div>
            ...
            <div>
                ...
                @if ($user->rombong && $user->rombong->foto_rombong)
                    <img src="{{ asset('storage/' . $user->rombong->foto_rombong) }}"
            ...
            <div>
                ...
                <select name="status" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-yellow-500"
                    required>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit"
                    class="px-4 py-2 rounded-lg bg-yellow-600 text-white hover:bg-yellow-700">Update</button>
            </div>
        </form>
    </div>
@endsection
